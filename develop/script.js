//add current day and time at the top of the planner (moment)
...
//this function to check each hour block to see if it is past (light gray), present (hex), or future (pastel green).
...
//this text area, class = "event"; if Save button clicked, set item to local storage and persist; upon refresh, get item from local storage.
